...
// 获取 USDC (或未来 pUSD) 余额辅助函数
async function getCashBalance(): Promise<number> {
  try {
    // 兼容 V2 升级：4月28日后可以通过环境变量 POLYMARKET_COLLATERAL_ADDRESS 切换为 pUSD 地址
    const collateralAddress = process.env.POLYMARKET_COLLATERAL_ADDRESS || '0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174'; // 默认 USDC.e
